...
38. Evidence and verifier authorization-state retention are minimal and declared; terminal verifier flows retain no attempt binding, replay registration, or attempt allocation; replay records end at challenge expiry and issuance-rate events end with their enforcement window unless a separately approved finite retention purpose applies.
