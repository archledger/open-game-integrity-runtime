...
| [ADR-0009](0009-capability-gated-appraisal-results.md) | Accepted | Unsigned Appraisal Results preserve exact context, claim-free phase-eligible failures, and one-use allow provenance. | None | None |
