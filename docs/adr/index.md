...
| [ADR-0014](0014-renewal-revocation-semantics.md) | Proposed | Renewal uses fresh evidence and one coherent session owner; finite authorization and authenticated revocation freshness bound protected use. | None | None |
